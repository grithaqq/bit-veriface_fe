...
export function useRunnerSearchLogic() {
    ...
    // Derived: slice untuk halaman saat ini
    ...
    const handleSearch = async () => {
        if (!uploadedImage) { setError('Upload gambar terlebih dahulu'); return; }
        ...
        try {
            ...
            if (!response.ok) throw new Error('Search gagal');
