...
import { useRunnerSearchLogic, getSearchImageUrl, SEARCH_PAGE_SIZE } from './useRunnerSearchLogic';
import Pagination from '@/app/ui/Pagination';

export default function RunnerSearchUI(props: ReturnType<typeof useRunnerSearchLogic>) {
    const {
        isLoading,
        topK,
        setTopK,
        ...
        <div className="flex flex-col md:flex-row h-full bg-base-200 -mx-8 -my-5 overflow-hidden">
            ...
            <aside className="w-full md:w-80 bg-base-100 border-r border-base-200 flex flex-col z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)] shrink-0 h-[calc(100vh-64px)] overflow-y-auto">
                <div className="p-6 flex-1 flex flex-col">
                    <h2 className="text-xl font-bold mb-6">Cari Wajah 🔍</h2>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex justify-between items-end mb-6">
                        ...
                        {hasSearched && (
                            <span className="text-sm font-medium text-base-content/50">
                                Menampilkan {searchResults.length} dari {allResults.length}
                            </span>
                        )}
                    </div>
                    ...
                    {!hasSearched && (
                        <div className="flex flex-col items-center justify-center h-64 text-base-content/40 bg-base-100 rounded-3xl border border-base-300 border-dashed">
                            ...
                            <p className="text-lg font-medium">Upload foto dan klik "Cari Wajah"</p>
                            <p className="text-sm mt-1">Sistem akan menampilkan foto yang mirip dari database.</p>
                        </div>
                    )}
                    ...
                    {hasSearched && !isLoading && allResults.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-64 text-base-content/40 bg-base-100 rounded-3xl border border-base-300">
                            <p className="text-lg font-medium">Tidak ditemukan hasil.</p>
                            <p className="text-sm mt-1">Coba foto yang berbeda atau perbesar nilai Top-K.</p>
                        </div>
                    )}
